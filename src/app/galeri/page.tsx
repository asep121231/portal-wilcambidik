...
import { getActivitiesWithPagination, getActivityCategories, type Activity, type ActivityCategory } from '@/lib/actions/gallery'
...
export default function GaleriPage() {
    ...
    useEffect(() => {
        async function loadData() {
            setIsLoading(true)
            const [activitiesResult, categoriesData] = await Promise.all([
            ...
            setTotalPages(Math.max(1, Math.ceil(activitiesResult.total / itemsPerPage)))
